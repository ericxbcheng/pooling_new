...
tune_param_covid(Args = Args_default, n_iter = n_iter, param = "n_pos", val = 5)
tune_param_n_covid(vals = c(1,3,5), Args = Args_default, n_iter = 10, var_prim = "n_pos")
tune_param_sec_covid(Args = Args_default, var_prim = "n_pos", vals_prim = c(1,3,5), 
